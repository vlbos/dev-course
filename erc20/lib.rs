...
mod erc20 {
    ...
    impl IERC20 for ERC20 {
        ...
        fn transfer_from(&mut self, from: AccountId, to: AccountId, value: Balance) -> Result<()> {
            ...
            if from != caller {
                ...
                if allowance < value {
                    return Err("Error::InsufficientAllowance".to_owned());
                }
            }
            ...
            if from != caller {
                ...
                self.allowances.insert(
                    ...
                    &allowance
                        .checked_sub(value)
                        .ok_or("Error::InsufficientAllowance".to_owned())?,
                );
            }
            Ok(())
        }
        ...
        fn update_impl(
            ...
            if let Some(from) = &from {
                ...
                self.balances.insert(
                    ...
                    &from_balance
                        .checked_sub(value)
                        .ok_or("Error::InsufficientBalance".to_owned())?,
                );
            } else {
    ...
    mod tests {
        ...
        fn new_works() {
            ...
            let erc20 = ERC20::new("test".to_owned(), "TEST".to_owned());

            // The `IERC20` trait has indeed been implemented.
            assert_eq!(<ERC20 as IERC20>::total_supply(&erc20), 0);
        }
        ...
        fn transfer_works() {
            ...
            let mut erc20 = ERC20::new("test".to_owned(), "TEST".to_owned());
        ...
        fn invalid_transfer_should_fail() {
            ...
            assert_eq!(
                ...
                Err("Error::InsufficientBalance".to_owned())
            );
        ...
        fn transfer_from_works() {
            ...
            assert_eq!(
                ...
                Err("Error::InsufficientAllowance".to_owned())
            );
            // Set Bob as caller.
